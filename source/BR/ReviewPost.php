            ...
            <div class="container">
                <div class="row">
                    <div class="span12">
                        ...
                        echo '<h4 class="rheading">' . $Flavor_Name . '에 대한 리뷰 작성하기 <span class="span100"></span></h4>
                            <form action="ReviewSave.php" method="post">
                            <input type="hidden" name="Flavor" value="' . $Flavor .'">
                            <div class="form-group" style="text-align:center">
                            <label for="Content">리뷰 내용</label>
                            <textarea style="width: 90%" name="Content" class="form-control" rows="10"></textarea>
                          ...
                          <button class="btn btn-primary btn-block pbc" style="height:5%; margin-top:20px;" type="submit">리뷰 남기기</button>
                        </form>';
                        ?>
                    </div>
                </div>
